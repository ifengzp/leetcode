...
<!--sec data-title="js代码实现" data-id="List" data-collapse=true ces-->
```js
    class List {
        constructor() {
            this._dataStore = [];
...
<!--sec data-title="js代码实现" data-id="Stack" data-collapse=true ces-->
```js
    class Stack {
        constructor() {
            this._dataStroe = [];
...
<!--sec data-title="js代码实现" data-id="Queue" data-collapse=true ces-->
```js
    class Queue {
        constructor() {
            this._dataStore = [];
...
<!--sec data-title="js代码实现" data-id="LList" data-collapse=true ces-->
```js
    function Node(el) {
        this.element = el;
        this.next = null;
...
<!--sec data-title="js代码实现" data-id="Dictionary" data-collapse=true ces-->
```js
    class Dictionary {
        constructor() {
            this._dataStore = [];
...
<!--sec data-title="js代码实现" data-id="BST" data-collapse=true ces-->
```js
